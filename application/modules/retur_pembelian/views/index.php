  ...
  <div class="box">
    <div class="box-header with-border" style="display: flex;justify-content: space-between;">
      ...
      <div class="pull-right">
        <a href="<?= site_url('retur_pembelian/create'); ?>" class="btn btn-success mr-2">
...
<script>
  ...
  var argDataTables = {
    url: "<?= base_url(); ?>/retur_pembelian/get_datatables_json",
    columns: [                        
      {"data": "tanggal_beli"},
      {"data": "tanggal_beli"},
      {"data": "purchase_return_code"},
      {"data": "supplier_name"},
      {"data": "product_name"},
      {"data": "batch_number"},
      {"data": "quantity"},
  ...
  $('#tanggal_retur').on('change', function(e) {
    ...
    argDataTables.search.tanggal_retur = $(this).val();
    table.draw();
  })
</script>
