...
<section class="content">
  <div class="box">
    <div class="box-header with-border" style="display: flex;justify-content: flex-end;">
      <div>
        <a href="<?= site_url('surat_pemesanan_obat/create'); ?>" class="btn btn-success"><i class="fa fa-plus margin-right-lg"></i> Tambah</a>
      </div>
    </div>
    <div class="box-body">
...
<script>
  ...
  var argDataTables = {
    url: "<?= base_url(); ?>/surat_pemesanan_obat/get_datatables_json",
    columns: [                        
      {"data": "id"},
      {"data": "customer_name"},
      {"data": "order_date"},
